...
public class TaskRecyclerListFragment extends RecyclerListFragment {
    ...
    private static final String TAG = "TaskRecyclerFr";
    ...
    public void setPriorityOrdered(int version) {
    ...
    public void setWillingnessOrdered(int version) {
    ...
    protected RecyclerListAdapter createListAdapter() {
        ...
        RecyclerListAdapter adapter = new TaskRecyclerListAdapter(contextId, mTaskPersistenceProvider, mContextProvider, this);
        return adapter;
    }
    ...
    public class TaskRecyclerViewContextMenuInfo extends RecyclerViewContextMenuInfo {
        private Task task;
