 ...
 */
public class TaskRecyclerGridFragment extends Fragment implements OnStartDragListener {
    ...
    public TaskRecyclerGridFragment() {
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final TaskRecyclerListAdapter adapter = new TaskRecyclerListAdapter(getActivity(), this, mode);

        RecyclerView recyclerView = (RecyclerView) view;
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(adapter);

        final int spanCount = 2;//getResources().getInteger(R.integer.2);
